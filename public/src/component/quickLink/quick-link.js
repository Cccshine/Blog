	...
	return(
		<nav styleName="quick-link">
			{{
				...
				'logined':<div><Link to={"/user/"+props.username+"/activities"} styleName="quick-link-item" data-role="index-quick-link">{props.username}</Link><Link to="/" styleName="quick-link-item" data-role="index-quick-link" onClick={props.logout}>退出</Link></div>,
